...
import {
  ...
  IonItem, IonInput, IonButton, IonToast, IonLoading, IonIcon, IonList
} from '@ionic/react';
import { eyeOutline, eyeOffOutline } from 'ionicons/icons';

const usuarios = [
  { email: "admin@medicare.com", password: "admin123", nombre: "Ana García", rol: "admin" },
  { email: "recepcion@medicare.com", password: "recep123", nombre: "Pepita Pérez", rol: "recepcionista" },
      ...
      <IonContent className="ion-padding">
        <IonList>
          ...
          <IonItem>
            ...
            />
            <IonButton fill="clear" slot="end" onClick={() => setMostrarPassword(!mostrarPassword)}>
